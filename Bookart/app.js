var myBookart = angular.module("bookartApp", ['ngRoute', 'ngResource', 'ngAnimate']);

myBookart.config(function ($routeProvider) {
    $routeProvider
        .when('/books', {
...
myBookart.factory("bookService", function () {
    var books = [
        {
...
myBookart.factory("kartService", function () {
